...
run = do
  ...
  -- trace-view semantics: tool filter + limit
  ...
  -- trace-view semantics: slow-only
  ...
  -- slow-inputs semantics: join slow_inputs with traces
  ...
  -- stats semantics: mean/stddev/count via Statistics module
  ...
  -- trace-clean semantics: delete rows older than N days
